...
//-----------------------------------------------------------------------------
//    目录
//1 ■ DataManager(管理数据库和游戏对象的静态类)
//2 ■ ConfigManager(管理配置数据的静态类)
//3 ■ StorageManager(管理存储游戏数据保存)
//4 ■ ImageManager(管理图像的静态类 加载创建位图对象并保留)
//5 ■ AudioManager(管理音频的静态类BGM, BGS, ME,  SE)  
//6 ■ SoundManager(管理声频的静态类)  
//7 ■ TextManager(管理文本的静态类 处理条件和消息)  
//8 ■ SceneManager(管理场景转换的静态类)  
//9 ■ BattleManager(管理战斗进展的静态类)  
//A ■ PluginManager(管理插件的静态类) 
//=============================================================================
//=============================================================================
// ■ DataManager(管理数据库和游戏对象的静态类) //ok
//=============================================================================
...
DataManager._globalId       = 'RPGMV';// 全局
DataManager._lastAccessedId = 1;   // 记录
DataManager._errorUrl       = null;// 错误
...
//=============================================================================
// ■ ImageManager(管理图像的静态类 加载创建位图对象并保留)//ok
//=============================================================================
...
//=============================================================================
// ■ AudioManager(管理音频的静态类BGM, BGS, ME,  SE) //ok
//=============================================================================
...
//=============================================================================
// ■ TextManager(管理文本的静态类 处理条件和消息) //ok
//=============================================================================
